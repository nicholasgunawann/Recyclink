...
class SellerOrderController extends Controller implements HasMiddleware
{
    ...
    {
        $orders = auth()->user()->sellerOrders()->with(['buyer.buyerProfile', 'payment', 'items.listing.primaryImage'])->latest()->paginate(15);
    ...
    public function show(Order $order)
    {
        ...
        $order->load(['buyer', 'items.listing', 'payment', 'complaints']);
