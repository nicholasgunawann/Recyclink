...
<section class="bg-gray-50 py-20" id="keunggulan">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="md:col-span-2 bg-brand rounded-3xl p-8 relative overflow-hidden flex flex-col justify-center group hover:-translate-y-1 hover:shadow-xl hover:shadow-brand/30 transition-all duration-300 scroll-reveal">
            ...
            <div class="md:col-span-1 bg-white border border-gray-200 rounded-3xl p-8 flex flex-col group hover:-translate-y-1 hover:shadow-xl hover:border-brand/30 transition-all duration-300 scroll-reveal">
            ...
            <div class="md:col-span-2 bg-white border border-gray-200 rounded-3xl p-8 flex flex-col group hover:-translate-y-1 hover:shadow-xl hover:border-brand/30 transition-all duration-300 scroll-reveal">
