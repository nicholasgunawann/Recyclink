...
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-900">Pusat Resolusi</h2>
    </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-gray-50 border-b border-gray-100 text-gray-500 text-xs uppercase tracking-wider">
                            ...
                            <th class="px-6 py-4 font-bold">Subjek</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('buyer.orders.show', $complaint->order_id) }}" class="text-brand hover:underline font-semibold text-sm">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('buyer.complaints.show', $complaint->id) }}" class="inline-flex items-center justify-center bg-gray-100 hover:bg-gray-200 text-gray-700 w-9 h-9 rounded-xl transition-colors">
    ...
    @else
        <div class="text-center py-20 bg-white rounded-2xl shadow-sm border border-gray-100">
            ...
            <p class="text-gray-500">Anda belum mengajukan komplain atau resolusi apapun.</p>
        </div>
    @endif
</div>
@endsection
