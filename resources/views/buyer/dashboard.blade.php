...
<div class="mb-8">
    <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight mb-2">Dashboard Pembeli</h1>
    ...
    <p class="text-gray-600 mt-1 text-base sm:text-lg">Selamat datang! Berikut ringkasan aktivitas belanja limbah Anda.</p>
</div>
