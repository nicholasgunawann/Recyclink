...
<div class="p-6">
    <div class="mb-6 flex items-center justify-between">
        <a href="{{ route('seller.complaints.index') }}" class="inline-flex items-center gap-2 text-gray-500 hover:text-brand transition-colors font-medium">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <a href="{{ route('seller.orders.show', $complaint->order_id) }}" class="font-bold text-brand hover:underline">{{ $complaint->order->order_code }}</a>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500">Pembeli (Complainant)</p>
                        <p class="font-bold text-gray-900">{{ $complaint->complainant->name }}</p>
                    </div>
                    <div>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col h-[600px]">
                <div class="p-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50 rounded-t-2xl">
                    ...
                    <p class="text-xs text-gray-500">Diskusi antara Anda dan Pembeli</p>
                </div>
